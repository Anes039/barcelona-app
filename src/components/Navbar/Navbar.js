...
const Navbar = () => {
  const carouselItems = [
    {
      id: "1",
      img: "https://www.fcbarcelona.com/photo-resources/2023/08/01/6679919f-9493-461f-b29e-c7dc693afba5/ENG-FLASH30.jpg?width=864&height=676",
      text: "30% discount on Tickets for Gamper Trophy and La Liga",
    },
    {
      id: "2",
      img: "https://www.fcbarcelona.com/photo-resources/2023/08/14/a638c58a-130f-42df-a21a-3ada685a4719/3200x2000-JOC-puzle-primer_golejador_la_liga-.jpg?width=864&height=676",
      text: "Solve these opening goalscorer puzzles",
    },
    {
      id: "3",
      img: "https://www.fcbarcelona.com/photo-resources/2023/08/02/0d6f2c93-3c26-4851-a301-0bd20083c094/_SG_9808.jpg?width=864&height=676",
      text: "On the way up to America",
    },
  ];
    ...
    <Card>
      <div className={classes.navbarContainer}>
        <div className={classes.navbar}>
          <img className={classes.barca} src={BarcaLogo} alt="" />
        ...
        <div className={classes.text_and_iconnn}>
          <h3>Barca Team</h3>
          <img className={classes.arrow_three} src={arrow} alt="arrow" />
        </div>
        ...
        <div className={classes.yellow_menu}>
          <div className={classes.museum}>
            ...
            {isTicketDropDownShown && (
              <div
                className={`${classes.thirdDropdown} ${classes.fadeIn} show`}
              >
                <ul>
          ...
          <div className={classes.culers}>
            ...
            {isCulersDropDownShown && (
              <div
                className={`${classes.fourthDropdown} ${classes.fadeIn} show`}
              >
                <ul>
